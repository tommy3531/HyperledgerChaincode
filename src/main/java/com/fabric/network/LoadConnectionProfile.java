...
public class LoadConnectionProfile {
    ...
    private LoadConnectionProfile() throws Exception {
        ...
        config = NetworkConfig.fromJsonFile(new File("/home/mike/Documents/Hyperledger/HyperledgerFabric-Java-Client/src/main/java/com/fabric/config/network-config.json"));
